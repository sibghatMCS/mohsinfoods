	...
	class renderer
	{
		...
		function menu_footer($no_menu, $is_index)
		{
			...
			if ($no_menu == false)
			{
				...
				echo "<tr>\n";
				echo "<td align='center' class='footer'><a target='_blank' href='$power_url' tabindex='-1'><font color='#ffffff'>$app_title - ".show_users_online()."</font></a></td>\n";
				echo "</tr>\n";
				echo "<tr>\n";
