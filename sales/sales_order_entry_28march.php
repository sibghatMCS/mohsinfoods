...
?>
<center>
    <table><tr><td><table class="tablestyle2"><tr><td>Search Customer: </td></tr>
    <tr><td><input type="text" onkeyup="customer(this.value)" name="search"/></td></tr>
...
<td>
    <form action="manage/create_customer.php" method="POST">
    <table class="tablestyle2" ><tr><td>Create New Customer</td></tr>
        <tr><td>Name:</td><td><input type="text" name="cus_name" /></td>     </tr>
        <tr><td>Phone:</td><td><input type="text" name="cus_phone" /></td>     </tr>
        <tr><td>Address:</td><td><input type="text" name="cus_address" /></td>     </tr>
        <tr><td>Email:</td><td><input type="text" name="cus_email" /></td>     </tr>
        <tr><td colspan="2" style="text-align: right"><input  type="submit" value="Add customer" name="submit" /></td>     </tr>
...
xmlhttp.open("GET","getcustomer.php?val="+val,true);
xmlhttp.send();
    ...
    document.getElementsByName('customer_id')[0].value =id;
...
//if(isset($_SESSION['add_cus1']))
//{ echo 'askdkljalsd'; exit; }
if ($customer_error == "") {
