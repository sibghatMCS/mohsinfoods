...
class inventory_app extends application
{
	function inventory_app()
	{
		...
		$this->add_lapp_function(1, _("&Items"),
		...
		$this->add_lapp_function(1, _("Item &Categories"),
		...
		$this->add_rapp_function(1, _("&Units of Measure"),
			"inventory/manage/item_units.php?", 'SA_UOM', MENU_MAINTENANCE);
		$this->add_rapp_function(1, _("&Reorder Levels"),
		...
		$this->add_lapp_function(2, _("Purchasing &Pricing"),
			"inventory/purchasing_data.php?", 'SA_PURCHASEPRICING', MENU_MAINTENANCE);
		$this->add_rapp_function(2, _("Standard &Costs"),
